...
- high priority
- due dates
- clarifying question (ask for clarity)

Left sidebar which shows today/past dates vertically so you can pick back in history to view tasks

Search bar to search through tasks
Ways to filter by date, categories, priority, etc
Easy way to edit existing tasks

When doing "date sent" it should auto fill for today's date.

Categories should do a full highlight of the task card (in a light color)

Tasks should have the ability to have sub tasks (and not be completed until all sub tasks are done). Sub tasks should
just be a simple text field and "done" option

Completed tasks for the day should show up at the bottom of open tasks with a line break and they should be greyed out

### Bugs

When pressing N to open a new task, "n" is in the task name
